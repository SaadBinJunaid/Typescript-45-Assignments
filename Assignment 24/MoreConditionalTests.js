...
console.log("Inequality with strings:", "Apple" != "orange");
...
console.log("tests involving inequality:", 20 != 10);
// // greater than:
...
console.log("Tests using or operators:", 12 != 15 || false);
// //Test whether an item is in a array:
const daysName = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday"];
...
console.log("\nnow false tests:\n");
//Tests for equality and inequality with strings:
console.log("Equality test with strings:", "Apple" === "Mango");
//Tests for inequality with strings:
console.log("Inequality with strings:", "Apple" != "Apple");
//Tests using the lower case function:
console.log("using the lower case function:", "HELLO".toLowerCase() === "HELLO");
//Numerical tests involving equality and inequality: greater than and less than, greater than or equal to, and less than or equal to
//Numerical tests involving equality:
console.log("Numerical tests involving equality:", 10 === 20);
//tests involving inequality:
console.log("tests involving inequality:", 20 != 20);
// greater than:
...
// Tests using "and" and "or" operators:
//Tests using "and" operators:
console.log("Tests using and operators:", 60 === 55 && 100 > 178);
//Tests using "or" operators:
console.log("Tests using or operators:", 12 != 12 || false);
//Test whether an item is in a array:
